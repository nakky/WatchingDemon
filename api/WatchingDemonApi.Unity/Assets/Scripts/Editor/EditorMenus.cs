...
static class EditorMenus
{
    ...
    static void UpdateSources()
    {
        ...
        {
            string sourcePath = Path.Combine(Application.dataPath, "../../WatchingDemonApi/WatchingDemonApi/");
            string targetPath = Path.Combine(Application.dataPath, "./WatchingDemonApi/Scripts/");
